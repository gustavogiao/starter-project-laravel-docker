...
<div class="container py-5">
    ...
    <form action="{{ route('tasks.update', $task->id) }}" method="POST" class="bg-white p-4 rounded shadow-sm">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3 form-check">
            <input type="checkbox" name="is_completed" id="is_completed" class="form-check-input" value="1" {{ old('is_completed', $task->is_completed) ? 'checked' : '' }}>
